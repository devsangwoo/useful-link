...
- [Lodash_Doc](https://lodash.com/docs/4.17.11)
...
- [JavaScript 바보들을 위한 Promise 강의](https://programmingsummaries.tistory.com/325)
- [JsFiddle](https://jsfiddle.net/mahbub/qx4tajL6/)
- [JavaScript essentials: 엔진 동작을 알아야 하는 이유](http://devtimothy.tistory.com/m/94)
...
[ubuntu 에 nodejs , Express, mysql 배포하기](https://github.com/outofmap/weddingCard/wiki/ubuntu-%EC%97%90-nodejs-,-Express,-mysql-%EB%B0%B0%ED%8F%AC%ED%95%98%EA%B8%B0-(How-to-deploy-nodejs-app-with-express,-mysql-using-ubuntu))

[CentOS,우분투 mysql 설치](https://www.lesstif.com/pages/viewpage.action?pageId=24445108)
